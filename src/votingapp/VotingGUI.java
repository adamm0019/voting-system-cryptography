...
public class VotingGUI extends javax.swing.JFrame {
    ...
    public VotingGUI() {
        ...
        model.setRowCount(0); // empty table on startup
    ...
    private void initComponents() {
        ...
        toolTipDialog = new javax.swing.JDialog();
        ...
        jLabel1.setText("Click a value in the hash column to copy it to your clipboard");

        javax.swing.GroupLayout toolTipDialogLayout = new javax.swing.GroupLayout(toolTipDialog.getContentPane());
        toolTipDialog.getContentPane().setLayout(toolTipDialogLayout);
        toolTipDialogLayout.setHorizontalGroup(
            toolTipDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, toolTipDialogLayout.createSequentialGroup()
                .addContainerGap(98, Short.MAX_VALUE)
                .addComponent(jLabel1)
                .addGap(82, 82, 82))
        );
        toolTipDialogLayout.setVerticalGroup(
            toolTipDialogLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, toolTipDialogLayout.createSequentialGroup()
        ...
        candidateSelectionComboBox.setToolTipText("Select a candidate to vote for");

        candidateVoteTable.setAutoCreateRowSorter(true);
        candidateVoteTable.setBackground(new java.awt.Color(242, 242, 242));
        candidateVoteTable.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        candidateVoteTable.setToolTipText("Click a value in the \"Hash\" column to copy it to clipboard");
        ...
        candidateVoteTable.setGridColor(new java.awt.Color(242, 242, 242));
        candidateVoteTable.getTableHeader().setResizingAllowed(false);
        candidateVoteTable.getTableHeader().setReorderingAllowed(false);
        ...
        voteButton.setToolTipText("Submit your vote for chosen candidate");
        ...
        totalVotes.setToolTipText("Use the generated hash to verify the integrity of your vote");
    ...
    private void voteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_voteButtonActionPerformed
        ...
        boolean shown = false;
        if (model.getRowCount() == 1 && shown != true) {
            shown = true;
            JOptionPane.showMessageDialog(this, "Click a value in the hash column to copy it to your clipboard");
        }
    ...
    private void candidateVoteTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_candidateVoteTableMouseClicked
        ...
        if (evt.getClickCount() == 1) { // if the user clicks the hash column
    ...
    private javax.swing.JDialog toolTipDialog;
